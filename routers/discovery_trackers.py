...
# Add a tracker
@router.post('/', status_code=status.HTTP_201_CREATED, response_model=Response, summary='Add a tracker')
...
# Delete a tracker
@router.delete('/{tracker_id}', status_code=status.HTTP_200_OK, response_model=Response, summary='Delete a tracker')
...
@router.post('/{tracker_id}/documents', status_code=status.HTTP_201_CREATED, response_model=Response, summary='Add a document to a tracker')
...
@router.delete('/{tracker_id}/documents/{document_id}', status_code=status.HTTP_200_OK, response_model=Response, summary='Delete a document from a tracker')
